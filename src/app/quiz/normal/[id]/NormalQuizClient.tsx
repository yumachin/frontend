...
export default function NormalQuizClient({ question }: { question: QuestionType }) {
  const { user } = useUser()
  ...
  const handleAnswer = async () => {
    try {
      ...
      if (res.message) {
        router.push(`/answer/${question.questionId}?level=normal&selectedAnswer=${selectedAnswer}`)
      } else {
